...
__C.data.image_feat_train = ["detectron_fix_100/fc6/vqa/train2014",
...
__C.data.image_feat_val = ["detectron_fix_100/fc6/vqa/val2014"]

__C.data.imdb_file_test = ["imdb/imdb_test2015.npy"]
# __C.data.image_feat_test = ["rcnn_10_100/vqa/test2015"]
__C.data.image_feat_test = ["detectron_fix_100/fc6/vqa/test2015"]
...
# __C.model.modal_combine = ModelParPair('MultiModalPCA')
...
# top_down_bottom_up.modal_combine = ModelParPair('MultiModalPCA')
