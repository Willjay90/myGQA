...
class AttQuestionEmbedding(nn.Module):
    def __init__(self, num_vocab, **kwargs):
        ...
        self.conv1 = nn.Conv1d(
            in_channels=kwargs['LSTM_hidden_size']*2,
        ...
        self.conv2 = nn.Conv1d(
            ...
            kernel_size=kwargs['kernel_size'],
            padding=kwargs['padding'])
        self.text_out_dim = kwargs['LSTM_hidden_size'] * 2 * kwargs['conv2_out']
        ...
        if 'embedding_init_file' in kwargs \
            ...
            embedding_init = np.load(embedding_file) # (25541, 300)
    ...
    def forward(self, input_text):
        ...
        #print("T: ", lstm_out.shape) # 128 * 14 * 1024
