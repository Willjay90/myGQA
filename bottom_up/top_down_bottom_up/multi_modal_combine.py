...
from top_down_bottom_up.nonlinear_layer import nonlinear_layer, linear_layer
...
def build_modal_combine_module(method, par, image_feat_dim, ques_emb_dim):
    ...
    # test
    elif method == "MultiModalPCA":
        return MultiModalPCA(image_feat_dim, ques_emb_dim, **par)
    else:
