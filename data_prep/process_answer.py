...
def filter_answers(answers_dset, min_occurence):
    occurence = {}
    answer_list = []
    for key in answers_dset:
        ans_entry = answers_dset[key]["answer"]
        gtruth = preprocess_answer(ans_entry)
        if gtruth not in occurence:
            occurence[gtruth] = set()
        occurence[gtruth].add(key)
...
if __name__ == '__main__':
    ...
    answer_file_name = 'answers_gqa_%d.txt' % min_freq
